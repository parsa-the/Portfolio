      ...
      <div className="relative z-10 flex flex-col-reverse sm:flex-row items-center sm:items-start gap-10 sm:gap-12 lg:gap-16">
        ...
        >
          ...
          <motion.h1
            ...
            className="font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl bg-gradient-to-r from-blue-300 via-blue-500 to-blue-200 bg-clip-text text-transparent leading-tight"
          >
            Frontend Developer
          </motion.h1>
