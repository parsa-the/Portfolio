...
import { OnePage } from "../ui/Card";
const Project = () => {
  return (
    <section id="Projects" className="flex mt-185 mb-30 h-450 items-center justify-center sm:h-250">
      <div>
        <motion.h1
        ...
        {/*asbjkandjnakjcajkxkjansc */}
        <div className="flex mt-5 mb-155 flex-wrap justify-center gap-5">
          {OnePage.map((card, index) => {
            return (
              <div key={index} className="w-80 border rounded-lg p-5 shadow-lg">
                <div className="h-60 flex w-full overflow-auto rounded-lg mb-4 hide-scrollbar">
                  <Image
                    className="w-full h-auto"
                    src={card.image}
                    height={200}
